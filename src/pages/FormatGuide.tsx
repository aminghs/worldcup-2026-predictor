  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="card mt-8 p-6">
        <h2 className="mb-4 font-display text-lg font-bold text-ink">The road to the final</h2>
        <div className="flex flex-wrap items-center gap-2 text-sm">
          {[
            ...
            <span key={label} className="flex items-center gap-2">
              <span className="chip bg-brand/10 text-brand">{label}</span>
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="card grid place-items-center p-6">
      <span className="font-display text-4xl font-bold text-brand">{value}</span>
